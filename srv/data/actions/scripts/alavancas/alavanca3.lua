...
local seetime = getGlobalStorageValue(63259)-os.time()
if getGlobalStorageValue(63259) > os.time() then return doPlayerSendCancel(cid,"Wait "..math.floor(seetime/60).." minutes and "..math.floor(seetime%60).." seconds to enter the quest!") end


player1pos = {x = 1482, y = 3416, z = 7, stackpos=253}
player1 = getThingfromPos(player1pos)

player2pos = {x = 1481, y = 3416, z = 7, stackpos=253}
player2 = getThingfromPos(player2pos)

player3pos = {x = 1478, y = 3411, z = 7, stackpos=253}
player3 = getThingfromPos(player3pos)

player4pos = {x = 1478, y = 3410, z = 7, stackpos=253}
player4 = getThingfromPos(player4pos)

player5pos = {x = 1481, y = 3422, z = 7, stackpos=253}
player5 = getThingfromPos(player5pos)

player6pos = {x = 1481, y = 3421, z = 7, stackpos=253}
...
queststatus6 = getPlayerStorageValue(player6.uid,9017)
    ...
    nplayer1pos = {x = 1497, y = 3415, z = 7}
	nplayer2pos = {x = 1497, y = 3417, z = 7}
	nplayer3pos = {x = 1496, y = 3416, z = 7}
	nplayer4pos = {x = 1499, y = 3417, z = 7}
	nplayer5pos = {x = 1499, y = 3415, z = 7}
	nplayer6pos = {x = 1497, y = 3419, z = 7}
        ...
        setGlobalStorageValue(63259, cooldown*60 + os.time())
    else
    return doPlayerSendCancel(cid,"Someone from this group has already done the quest!")
    end
else
return doPlayerSendCancel(cid,"6 players are required to start this quest!.")
end
return true
end