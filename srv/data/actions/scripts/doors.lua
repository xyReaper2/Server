local portasVerticais = {3549, 7038,12195,194, 195, 196, 197, 5294, 1261, 8557, 9181, 6265, 5103, 6896, 9283, 6208, 7038, 1500, 9179} --ids das portas que sao na posicao vertical
local portasHorizontais = {12193, 12249,1259, 191, 192, 193, 5292, 1227, 6905, 6263, 9179, 1500, 1245} --ids das portas que sao na posicao horizontal
...
if isInArray(portasHorizontais, item.itemid) then
	if toPosition.x < getPlayerPosition(cid).x then
    doTeleportThing(cid, {x=toPosition.x-1, y=toPosition.y, z=toPosition.z})
	elseif toPosition.x > getPlayerPosition(cid).x then
    doTeleportThing(cid, {x=toPosition.x+1, y=toPosition.y, z=toPosition.z})
	end
elseif isInArray(portasVerticais, item.itemid) then
	if toPosition.y < getPlayerPosition(cid).y then
    doTeleportThing(cid, {x=toPosition.x, y=toPosition.y-1, z=toPosition.z})
	elseif toPosition.y > getPlayerPosition(cid).y then
    doTeleportThing(cid, {x=toPosition.x, y=toPosition.y+1, z=toPosition.z})
	end
end
end
