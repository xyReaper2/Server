...
selfSay('I need 100 {nukenin} talisma, bring it to me and I,ll reward you', cid)
end
---------------------------------------------------------
if(msgcontains(msg, 'nukenin')) then
selfSay('do you have 100 nukenin talisma to "get me"?', cid)
...
if(doPlayerRemoveItem(cid, 13925, 100) == true) then
setPlayerStorageValue(cid,104,1)
doPlayerAddExperience(cid,14000)
doPlayerAddEloPoints(cid,12)
