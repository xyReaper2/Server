...
selfSay('hello young adventurer, I need 200 bat {wings} to make medicine because my son is adopted', cid)
end
---------------------------------------------------------
if(msgcontains(msg, 'wings')) then
selfSay('do you have 200 wings to "get me"?', cid)
...
if(doPlayerRemoveItem(cid, 11189, 200) == true) then
