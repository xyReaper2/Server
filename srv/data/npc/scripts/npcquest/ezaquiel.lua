...
selfSay('bring me 100 Demon {Dust} that i will reward you', cid)
end
---------------------------------------------------------
if(msgcontains(msg, 'Dust')) then
selfSay('do you have 100 Demon Dust to "get me"?', cid)
...
if(doPlayerRemoveItem(cid, 12381, 100) == true) then
setPlayerStorageValue(cid,108,1)
doPlayerAddExperience(cid,14000)
doPlayerAddEloPoints(cid,20)
