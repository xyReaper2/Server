...
selfSay('I need you to bring me 100 white line and 100 magic essence, when the "finish" let me know!', cid)
end
---------------------------------------------------------
...
if (getPlayerStorageValue(cid,181006) > 0) then
selfSay('you already finished this mission.', cid)
else
if getPlayerItemCount(cid, 17435) >= 100 and getPlayerItemCount(cid, 11155) >= 100 then
doPlayerRemoveItem(cid, 17435, 100)
doPlayerRemoveItem(cid, 11155, 100)
setPlayerStorageValue(cid,181001,1)
doPlayerAddExperience(cid,21000)
doPlayerAddItem(cid,15488,1)
