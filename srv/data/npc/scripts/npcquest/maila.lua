...
selfSay('I heard that Giant Fear/s "eyes" are miraculous, I need 25 giant eyes to cure my son of blindness.', cid)
end
---------------------------------------------------------
if(msgcontains(msg, 'olhos', 'eyes')) then
selfSay('Do you already have the 15 giant eyes to "get me"?', cid)
...
if(doPlayerRemoveItem(cid, 11191, 25) == true) then
