...
selfSay('bring me 100 {green} piece that i will reward you', cid)
end
---------------------------------------------------------
if(msgcontains(msg, 'green')) then
selfSay('do you have 100 green piece to "get me"?', cid)
...
if(doPlayerRemoveItem(cid, 12383, 100) == true) then
