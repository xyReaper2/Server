...
selfSay('bring me 50 {mother} Soil that i will reward you', cid)
end
---------------------------------------------------------
if(msgcontains(msg, 'mother')) then
selfSay('do you have 50 mother soil to "get me"?', cid)
...
if(doPlayerRemoveItem(cid, 8305, 50) == true) then
