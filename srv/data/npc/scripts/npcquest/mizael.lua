...
selfSay('bring me 10 Wings Of {Fire} that i will reward you', cid)
end
---------------------------------------------------------
if(msgcontains(msg, 'Fire')) then
selfSay('do you have 10 Wings Of Fire to "get me"?', cid)
...
if(doPlayerRemoveItem(cid, 17438, 10) == true) then
setPlayerStorageValue(cid,112,1)
doPlayerAddExperience(cid,14000)
doPlayerAddEloPoints(cid,35)
