...
selfSay('bring me 150 Magic {essence} that i will reward you', cid)
end
---------------------------------------------------------
if(msgcontains(msg, 'essence')) then
selfSay('do you have 150 Magic essence to "get me"?', cid)
...
if(doPlayerRemoveItem(cid, 11155, 150) == true) then
