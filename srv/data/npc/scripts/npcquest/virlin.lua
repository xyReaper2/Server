...
selfSay('bring me 50 Freezing {Star} that i will reward you', cid)
end
---------------------------------------------------------
if(msgcontains(msg, 'Star')) then
selfSay('do you have 50 Freezing Star to "get me"?', cid)
...
if(doPlayerRemoveItem(cid, 5930, 50) == true) then
