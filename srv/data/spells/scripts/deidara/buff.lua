...
if isBuffed(cid, storageBuff, 1) then doPlayerSendCancel(cid, "Sua aura jรก esta ativa!.") return false end  
local mpos = getPlayerPosition(cid)
AddBuff(cid, skillpoint, speed, health, CONDITION_PARAM_SKILL_DISTANCE)
    tempo2 = 0
