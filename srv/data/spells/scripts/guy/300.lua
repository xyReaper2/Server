...
setCombatFormula(combat2, COMBAT_FORMULA_LEVELMAGIC, -38, 1, -42, 1)
...
doSendMagicEffect({x=t_Pos.x+2, y=t_Pos.y+2, z=t_Pos.z}, 915)
end
end
...
doSendMagicEffect({x = c_Pos.x+1, y = c_Pos.y, z = c_Pos.z}, 0)
return true
end 