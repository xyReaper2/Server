...
setCombatParam(combat, COMBAT_PARAM_TYPE, COMBAT_FIREDAMAGE)		---cura nivel 250
...
doSendMagicEffect(position1, 438)
doSendMagicEffect(position2, 438)
doSendMagicEffect(position3, 438)
