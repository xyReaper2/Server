...
setCombatParam(combat, COMBAT_PARAM_TYPE, COMBAT_HYOTONDAMAGE)	---ataque nivel 400
...
doSendMagicEffect(position1, 969)
doSendMagicEffect(position2, 937)
doSendMagicEffect(position3, 938)
doSendMagicEffect(position4, 942)
