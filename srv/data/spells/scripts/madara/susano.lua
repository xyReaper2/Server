...
local effect = {630} -- effect no player, caso queira apenas 1, basta remover os outros numeros.
...
if isPlayer(cid) and getPlayerStorageValue(cid, 102053) ~= 1 or getCreatureCondition(cid, CONDITION_REGENERATION, 1) == false then
