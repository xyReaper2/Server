...
setCombatParam(combat, COMBAT_PARAM_TYPE, COMBAT_SUITONDAMAGE)		---balanço nivel 350
...
doPlayerSendCancel(cid, "Aguarde "..exhaustion.get(cid, 963563).." segundo(s) para usar novamente!")
return false
end
...
doSendMagicEffect(position1, 581)
