...
setCombatParam(combat1, COMBAT_PARAM_EFFECT, 342)
...
local area1 = createCombatArea(AREA_CROSS3X3)
setCombatArea(combat1, area1)

local combat2 = createCombatObject()
setCombatParam(combat2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat2, COMBAT_PARAM_EFFECT, 294)
setCombatParam(combat2, COMBAT_PARAM_BLOCKSHIELD, true)
setCombatParam(combat2, COMBAT_PARAM_BLOCKARMOR, false)
setAttackFormula(combat2, COMBAT_FORMULA_LEVELMAGIC, 5, 5, 6, 12)

local area2 = createCombatArea(AREA_CROSS2aX2a)
