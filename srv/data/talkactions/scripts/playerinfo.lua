function onSay(cid, words, param, channel)
	...
	doPlayerPopupFYI(cid, "Information about player" ..
		...
		"\nStatus:" ..
			...
			"\nSkills:" ..
			"\nFist - " .. getPlayerSkillLevel(pid, SKILL_TAIJUTSU) .. ", Club - " .. getPlayerSkillLevel(pid, SKILL_GLOVE) .. ", Sword - " .. getPlayerSkillLevel(pid, SKILL_SWORD) .. ", Axe - " .. getPlayerSkillLevel(pid, SKILL_AXE) ..
